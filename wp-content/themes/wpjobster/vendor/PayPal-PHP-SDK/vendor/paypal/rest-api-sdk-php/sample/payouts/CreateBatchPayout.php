...
$senderItem2->setRecipientType('Email')
    ->setNote('Thanks you.from batch')
    ->setReceiver('dev-buyer@wpjobster.com')
    ->setSenderItemId(uniqid()."item_2")
    ->setAmount(new \PayPal\Api\Currency('{
                        "value":"0.99",
                        "currency":"USD"
                    }'));
...
/*foreach($paypal_payout_requests_info as $paypal_payout_info){
    $senderItem = new \PayPal\Api\PayoutItem(
        array(
            "recipient_type" => "Email",
            "receiver" => $paypal_payout_info['email'],
            "note" => "Thank you.",
