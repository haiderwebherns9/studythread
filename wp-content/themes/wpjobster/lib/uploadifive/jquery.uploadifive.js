        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                $data.addQueueItem = function(file) {
                    ...
                    var exts = JSON.parse( uploadifive_vars.allowed_mime_types );
                    var re = /(?:\.([^.]+))?$/;
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    $data.button = $('<div id="' + settings.id + '" class="ui left labeled icon button uploadifive-button"><i class="attach icon"></i>' + settings.buttonText + '</div>');
