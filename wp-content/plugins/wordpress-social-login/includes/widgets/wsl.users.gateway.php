...
<!DOCTYPE html>
	<head>
		...
		<style type="text/css">
			...
			label .intl-tel-input input[type="tel"]{
				width: 100%;
				border: 1px solid #e5e5e5;
				box-shadow: 1px 1px 2px rgba(200, 200, 200, 0.2) inset;
				color: #555;
			...
			label .intl-tel-input .selected-flag {
				height: 77% !important;
			}
		...
		<!-- My scripts -->
		<script src="<?php echo WORDPRESS_SOCIAL_LOGIN_PLUGIN_URL . 'assets/js/jquery-3.1.1.min.js'; ?>"></script>
		<script src="<?php echo WORDPRESS_SOCIAL_LOGIN_PLUGIN_URL . 'assets/js/intlTelInput.js'; ?>"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo WORDPRESS_SOCIAL_LOGIN_PLUGIN_URL . 'assets/css/intlTelInput.css'; ?>">
